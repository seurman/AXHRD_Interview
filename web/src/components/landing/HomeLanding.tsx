...
import { LandingPlatformTour } from "@/components/landing/LandingPlatformTour";
import { landingProductHref, landingStartHref } from "@/lib/landing/hrefs";
...
export function HomeLanding() {
  ...
  const features = [
    {
      icon: Mic2,
      ...h.features.interview,
      href: landingProductHref("interview", trialOnly),
    },
    {
      icon: Sparkles,
      ...h.features.discover,
      href: landingProductHref("discover", trialOnly),
    },
    {
      icon: BarChart3,
      ...h.features.tracking,
      href: landingProductHref("tracking", trialOnly),
    },
    {
      icon: Layers,
      ...h.features.cards,
      href: landingProductHref("cards", trialOnly),
    },
  ];
    ...
    <div className="lp">
        ...
        <div className="lp-shell lp-hero-grid">
          ...
          <div className="lp-hero-copy lp-hero-copy--actions">
            ...
            <div className="lp-hero-actions">
              ...
              <Link href={productIntroHref("organizations")} className="lp-btn-ghost">
        ...
        <div className="lp-shell lp-spotlight-grid">
          ...
          <Reveal delay={0.06}>
            <div>
              ...
              <Link href={landingProductHref("discover", trialOnly)} className="lp-btn-primary lp-btn-ink mt-8">
                {h.spotlight.cta}
                <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
      ...
      <section className="lp-enterprise">
        <div className="lp-shell lp-enterprise-inner">
          ...
          <div className="lp-hero-actions mt-8">
            <Link href={productIntroHref("organizations")} className="lp-btn-primary">
              {h.enterprise.cta}
              <ArrowRight className="h-4 w-4" />
            </Link>
            <Link href="/org/setup" className="lp-btn-ghost">
              {h.painPoints.contactCta}
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="lp-closing">
        <div className="lp-shell text-center">
          ...
          <Link href={startHref} className="lp-btn-primary lp-btn-ink mt-8">
