  ...
  openers: [
    {
      ...
      choices: [
        ...
        "카리스마로 분위기를 바꿔 팀원들이 따라오게 만드는 방식이 제 강점입니다.",
      ],
      answerIndex: 0,
    ...
    },
    {
      ...
      choices: [
        ...
        "다수결 결과만 따르며 제 판단은 최소화하는 쪽으로 결정을 처리했습니다.",
  ...
  traps: [
    {
      ...
      choices: [
        ...
        "리더 역할 경험이 많아 사람을 움직이는 데 익숙한 편입니다.",
    ...
    },
    {
      ...
      choices: [
        ...
        "팀원이 실행을 미뤄 결과가 아쉬웠고, 다음엔 체크인 주기를 더 짧게 잡았습니다.",
  ...
  boss: [
    {
      ...
      choices: [
        "사람들을 움직일 때는 카리스마로 분위기를 바꿔 자연히 따라오게 만들었습니다.",
