...
export const JOB_FIT_PACK: DuoPack = {
  ...
  openers: [
    ...
    },
    {
      ...
      choices: [
        "완성도를 끝까지 끌어올리기 위해 일정을 넉넉히 잡고 주변 피드백을 모두 반영한 경험이 핵심입니다.",
  ...
  traps: [
    {
      ...
      choices: [
        ...
        "브랜드 인지도만 보고 지원했고 구체 과업은 입사 후 맞춰 가려 합니다.",
    ...
    },
    {
      ...
      choices: [
        ...
        "관심 분야 아티클을 꾸준히 읽으며 지식을 쌓아 온 점이 강점입니다.",
      ],
      answerIndex: 0,
    ...
    },
    {
      ...
      choices: [
        ...
        "개선 이후 분위기가 좋아졌다는 말을 여러 번 들었습니다.",
      ],
      answerIndex: 1,
      skillRule: "quantify",
  ...
  boss: [
    {
      ...
      choices: [
        ...
        "우선 적응에 집중하고 구체적인 성과 목표는 6개월 뒤에 잡겠습니다.",
      ],
      answerIndex: 2,
